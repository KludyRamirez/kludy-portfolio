...
export default function Filled() {
  return (
    <div className="flex sm:justify-start lg:justify-center w-[100%] sm:h-[100%] lg:h-screen bg-[#0047AB] sm:px-[20px] lg:px-[200px] sm:py-[80px] lg:py-[180px] gap-[100px] sm:flex-wrap">
      ...
      <div className="sm:w-[100%] lg:w-[58%] h-[100%] flex flex-col justify-start gap-4">
        <div className="w-[100%] flex sm:justify-start lg:justify-start items-start sm:gap-16 lg:gap-4 sm:flex-wrap lg:pt-6">
          <Tilt>
